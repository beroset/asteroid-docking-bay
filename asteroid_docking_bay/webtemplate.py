...
function mkadbrow(p){
  ...
  if(p.wanze_probing)
    return `<span class="cbadge wanze" title="wanze measurement run in progress since ${fmtAge(p.wanze_probing.since)} ago — leave this watch alone; using it for anything else voids the run">wanze probing</span>`;
