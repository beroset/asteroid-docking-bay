...
# ── benchymark, the app ──────────────────────────────────────────────────────
# The watchface measures with the compositor's own blanking policy fighting it;
# the app can hold the screen (Nemo.KeepAlive is honoured for clients) and can
# write its results to disk. a-d-b therefore owns its whole lifecycle: install,
# start, stop, remove, and reading the last run back.
